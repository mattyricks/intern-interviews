...
import "./App.scss";
import profilePicture from "./images/matthewRicklefs.JPG";
    ...
    <>
      ...
      <div className="Parallax__content__cta">
        <p>
          ...
          pursuit of something meaningful that could very well translate into
          intellectual growth. Not to undermine all of the experience and
          knowledge that I've learned while being in the service industry,
          because it has provided important life lessons where in which I've
          acquired skills that translate into understanding how to cooperate
          with others, work hard, and create lasting experiences that bring joy
          to guests!
        </p>
        <p>
          To be a software engineer intern, I would like to learn how to develop
